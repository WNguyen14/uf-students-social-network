  ...
  return (
    <>
      ...
      {majors.map((major, i) => (
        <div key={i}>
          {major}
          <button onClick={() => setMajors(majors.filter((_, j) => i !== j))}>X</button>
        </div>
      ))}
      ...
      {courses.map((course, i) => (
        <div key={i}>
          {course}
          <button onClick={() => setCourses(courses.filter((_, j) => i !== j))}>X</button>
        </div>
      ))}
      <label>Courses</label>
      ...
      {interests.map((interest, i) => (
        <div key={i}>
          {interest}
          <button onClick={() => setInterests(interests.filter((_, j) => i !== j))}>X</button>
        </div>
      ))}
