...
const CreateProfile = ({ handleCreateProfile }) => {
  ...
  const addMajor = () => {
    if (
      ...
      !majors.includes(majorInput.current.value)
    ) {
  ...
  const addCourse = () => {
    if (
      ...
      !courses.includes(coursesInput.current.value)
    ) {
  ...
  const addInterest = () => {
    if (
      ...
      !interests.includes(interestsInput.current.value)
    ) {
      ...
      <ThemeProvider theme={theme}>
        <Container component="main" maxWidth="xs">
          ...
          >
              ...
              <OutlinedInput
                ...
                endAdornment={
                  <InputAdornment position="end">
                    <IconButton onClick={addMajor} edge="end">
                      <AddIcon />
                    </IconButton>
                  </InputAdornment>
                }
            ...
            <FormControl sx={{ mt: 1, width: "100%" }} variant="outlined">
              <InputLabel htmlFor="outlined-adornment-courses">
                Add Course
              </InputLabel>
              <OutlinedInput
                ...
                endAdornment={
                  <InputAdornment position="end">
                    <IconButton onClick={addCourse} edge="end">
                      <AddIcon />
                    </IconButton>
                  </InputAdornment>
                }
            ...
            >
              {interests.map((interest, i) => (
                <Cards
                  ...
                  text={interest}
                  click={() =>
                    setInterests(interests.filter((m, j) => i !== j))
                  }
                />
              ))}
            </Box>
            <FormControl sx={{ mt: 1, width: "100%" }} variant="outlined">
              <InputLabel htmlFor="outlined-adornment-interests">
                Add Interest
              </InputLabel>
              <OutlinedInput
                ...
                endAdornment={
                  <InputAdornment position="end">
                    <IconButton onClick={addInterest} edge="end">
                      <AddIcon />
                    </IconButton>
                  </InputAdornment>
                }
